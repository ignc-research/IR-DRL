...
class listener_node_one:
    ...
    def PointcloudToVoxel(self):
        ...
        if self.joints is not None and len(self.points_raw) != 0:
            ...
            #voxel_grid = o3d.geometry.VoxelGrid.create_from_point_cloud_within_bounds(pcd, voxel_size=self.voxel_size, min_bound=np.array([0, 0, 0]), max_bound=np.array([1, 1, 1]))
            ...
            #voxel_centers = (voxel_centers * self.voxel_size) * points_range + offset_min + self.points_lower_bound[:3]
