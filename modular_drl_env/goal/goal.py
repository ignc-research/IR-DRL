...
class Goal(ABC):
    ...
    def __init__(self, robot:Robot, normalize_rewards:bool, normalize_observations:bool, train:bool, add_to_observation_space: bool, add_to_logging:bool, max_steps:int, continue_after_success:bool=False):
        ...
        # names of the performance metric that this goal has, is used for external logging
        # overwrite this in your subclass
        # if you don't have performance metrics, leave as is
        # IMPORTANT: the actual metrics should be class variables with the exact same name as contained in this string, otherwise automatic logging will not work and create errors
        # example: self.metric_names = ["distance_threshold"], actual metric is class variable self.distance_threshold
        self.metric_names = [""]
    ...
    def on_env_reset(self, success_rate):
        ...
        The order of tuples should be the exact same as defined in the self.metric_names list.
        """
        pass
